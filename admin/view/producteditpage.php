                                ...
                                <div class="form-validation">
                                    <?php
                                        ...
                                        try {
                                            ...
                                            $stmt = $conn->prepare("SELECT `product_id`, `product_name`, `price`, `avtar`, `type_id` FROM `product` WHERE product_id=:product_id");
                                            ...
                                            IF($product){
                                                foreach($product as $product){
                                                   ...
                                                   echo ' <div class="row form-group">';
                                                        ...
                                                        echo '<div class="col-12 col-md-9"><input  id="txt_status" value="'.$product['type_id'].'" name="txt_type_id" class="form-control"></div>';
                                                    echo '</div>';
                                                    echo ' <div class="row form-group">';
                                                        echo '<div class="col col-md-3"><label for="password-input" class=" form-control-label">avatar</label></div>';
                                                        echo '<div class="col-12 col-md-9"><input  id="txt_avatar" value="'.$product['avtar'].'" name="txt_avtar" class="form-control"></div>';
                                                    echo '</div>';
                                                    echo '<div>';
